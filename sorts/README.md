...
Сортировки разделены по категориям:

- **[simple/](./simple)** - Простые сортировки O(n²) - вставка, выбор, пузырёк
- **[advanced/](./advanced)** - Улучшенные O(n log n) - быстрая, Шелла, гладкая
- **[external/](./external)** - Внешние сортировки - слияние, естественное слияние
- **[linear/](./linear)** - Линейные O(n) - подсчёт, карманная, поразрядная
