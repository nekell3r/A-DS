...
//
// ОСНОВНАЯ ФУНКЦИЯ:
//   int PolPZ(char* expression)  - вычислить выражение в префиксной записи
//
// АЛГОРИТМ:
//   1. Читаем строку СПРАВА НАЛЕВО
//   2. Цифра → кладём в стек
//   3. Оператор → вытаскиваем 2 числа (порядок: a, b), вычисляем, кладём результат
